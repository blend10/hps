      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between md:gap-12">
          <h2 className="max-w-xl text-4xl font-semibold leading-tight tracking-tight text-white md:text-5xl">
            Setting a New Standard in Protection with HPS
          </h2>

          <div className="flex max-w-md flex-col gap-5">
            <p className="text-sm leading-relaxed text-[#D3D3D3]">
              Racing Force Group, renowned for its legacy in motorsport safety
              innovation, embarked on a diversification journey following its
              listing in 2021. This vision gave rise to High Protection Systems
              SA (HPS), dedicated to adapting racing safety technologies for
        ...
        <div className="relative mt-12 aspect-video w-full h-150 rounded-sm bg-black">
          ...
          <span
            aria-hidden="true"
            className="pointer-events-none absolute -left-3 -top-3 z-20 h-8 w-8 border-l-4 border-t-4 border-white md:-left-5 md:-top-5 md:h-10 md:w-10"
          />
          <span
            aria-hidden="true"
            className="pointer-events-none absolute -bottom-3 -right-3 z-20 h-8 w-8 border-b-4 border-r-4 border-white md:-bottom-5 md:-right-5 md:h-10 md:w-10"
          />
